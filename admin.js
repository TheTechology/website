...
function AdminPage({
  ...
  const [authRole, setAuthRole] = uAs(() => {
    try {
      return localStorage.getItem('adn-admin-role') || 'admin';
    } catch {
      return 'admin';
    }
  });
  ...
  const useExternalTeam = !!setExtTeam;
  const [localTeam, setLocalTeam] = uAs(() => {
    try {
      const saved = localStorage.getItem('adn-admin-team');
  ...
  const team = useExternalTeam ? extTeam : localTeam;
  const setTeam = useExternalTeam ? setExtTeam : setLocalTeam;
  ...
  const handleLogout = () => {
    ...
    try {
      ...
      localStorage.removeItem('adn-admin-role');
    } catch {}
...
function AdminSidebar({
  ...
  const items = authRole === 'admin' ? allItems : allItems.filter(i => !i.adminOnly);
  ...
  }, authRole === 'admin' ? 'Administrator' : 'Agent de vânzări')), /*#__PURE__*/React.createElement("button", {
...
function AdminTopbar({
  ...
  const me = authRole === 'agent' && team ? team.find(m => m.name === authUser) : null;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    style: { fontSize: 11.5, color: 'var(--fg-muted)', textTransform: 'uppercase', letterSpacing: '0.04em' }
  }, "Clienți luna aceasta"), /*#__PURE__*/React.createElement("div", {
    style: { fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 22 }
  }, me.statsClientsMonth || 0)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 11.5, color: 'var(--fg-muted)', textTransform: 'uppercase', letterSpacing: '0.04em' }
  }, "Valoare auto v\xE2ndute"), /*#__PURE__*/React.createElement("div", {
    style: { fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 22 }
  }, "€ ", fmtPrice(me.statsSalesValueMonth || 0))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 11.5, color: 'var(--fg-muted)', textTransform: 'uppercase', letterSpacing: '0.04em' }
  }, "Comision generat"), /*#__PURE__*/React.createElement("div", {
    style: { fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 22, color: 'var(--accent)' }
  }, "€ ", fmtPrice(me.statsCommissionMonth || 0)))));
}
...
function CarEditor({
  ...
  const trySave = mode => {
    if (!car.brand?.trim() && !car.model?.trim()) {
      alert('Completează cel puțin Marca sau Modelul înainte de a salva mașina.');
      return;
    }
    if (mode === 'publish' && (!car.brand?.trim() || !car.model?.trim() || !car.price)) {
      alert('Pentru publicare sunt obligatorii: Marcă, Model și Preț. Poți salva ca draft până le completezi pe toate.');
      return;
    }
    onSave(car, mode);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    label: t.admin.fLeasingAvans,
    type: "number",
    prefix: "\u20AC",
    value: car.leasingAvans,
    onChange: v => update('leasingAvans', +v)
  }), /*#__PURE__*/React.createElement(Field, {
  ...
  }, authRole === 'admin' && /*#__PURE__*/React.createElement("button", {
    className: "btn btn-outline",
    onClick: () => {
      if (confirm(`Sigur ștergi ${car.brand || 'mașina'} ${car.model || ''}? Nu poți anula această acțiune.`)) onDelete(car.id);
    },
    disabled: isNew,
...
function MediaUploader({
  ...
  const [urlInput, setUrlInput] = uAs('');
  const [urlErr, setUrlErr] = uAs('');
  const [uploading, setUploading] = uAs(false);
  ...
  const addUrl = () => {
    ...
    if (!url.startsWith('http://') && !url.startsWith('https://')) {
      setUrlErr('URL-ul trebuie să înceapă cu https://');
      return;
    }
    update('photos', [...(car.photos || []), url]);
    setUrlInput('');
    setUrlErr('');
  };
    ...
    for (const file of files) {
      ...
      try {
        ...
        if (data.ok && data.url) {
          ...
          setUrlErr(data.error || 'Upload eșuat pentru ' + file.name);
        }
      } catch {
        setUrlErr('Eroare rețea la upload ' + file.name);
      }
    }
    if (urls.length) {
      update('photos', [...(car.photos || []), ...urls]);
    }
    setUploading(false);
  ...
  return /*#__PURE__*/React.createElement("div", null,
    /*#__PURE__*/React.createElement("div", {
      ...
      /*#__PURE__*/React.createElement("label", null, "Imagini mașină"),
      /*#__PURE__*/React.createElement("div", {
        style: { display: 'flex', gap: 8, flexWrap: 'wrap' }
      },
        /*#__PURE__*/React.createElement("input", {
          className: "form-input mono",
          placeholder: "https://example.com/imagine-masina.jpg",
          value: urlInput,
        ...
        /*#__PURE__*/React.createElement("label", {
          ...
          style: { flexShrink: 0, cursor: uploading ? 'wait' : 'pointer', opacity: uploading ? 0.6 : 1 }
        },
          uploading ? 'Se încarcă…' : '↑ Fișier local',
          /*#__PURE__*/React.createElement("input", {
            ref: fileRef,
            type: "file",
      ...
      urlErr && /*#__PURE__*/React.createElement("div", {
        style: { color: 'var(--err, #e74c3c)', fontSize: 12, marginTop: 4 }
      }, urlErr)
    ),
    /*#__PURE__*/React.createElement("div", {
      className: "media-url-hint"
    },
      /*#__PURE__*/React.createElement(IconInfo, { size: 13 }),
      " Adaugă imagini prin URL extern (ibb.co, imgur) sau încarcă fișiere local. Prima imagine devine foto principală."
    ),
    (car.photos || []).length > 0 && /*#__PURE__*/React.createElement("div", {
      ...
      /*#__PURE__*/React.createElement("div", {
        ...
        }, t.admin.mediaSetPrimary),
        /*#__PURE__*/React.createElement("button", {
          className: "pt-btn danger",
          onClick: () => removePhoto(i)
        }, /*#__PURE__*/React.createElement(IconClose, { size: 12 }))
      )
    ))),
    /*#__PURE__*/React.createElement("div", {
      className: "form-field",
      ...
      /*#__PURE__*/React.createElement("label", null, t.admin.mediaVideoUrl),
      /*#__PURE__*/React.createElement("input", {
        className: "form-input mono",
      ...
      car.videoUrl && /*#__PURE__*/React.createElement("div", {
        ...
        /*#__PURE__*/React.createElement(IconBolt, { size: 14 }),
...
function AdminTeam({
  ...
  }, team.length), "membri activi \xEEn echip\u0103"), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary btn-sm",
    onClick: onNew
...
function MemberEditor({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  })), authRole === 'admin' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "ep-head",
    style: {
      marginTop: 12
    }
    ...
    className: "ep-h"
  }, "Statistici lunare (privat, doar admin)"), /*#__PURE__*/React.createElement("p", {
    className: "ep-desc"
  }, "Vizibile doar acestui consultant, la logare — necesită completare manuală lunară.")), /*#__PURE__*/React.createElement("div", {
    className: "form-grid c-3"
  }, /*#__PURE__*/React.createElement(Field, {
    label: "Nr. clienți luna aceasta",
    type: "number",
    value: member.statsClientsMonth || 0,
    onChange: v => update('statsClientsMonth', +v)
  }), /*#__PURE__*/React.createElement(Field, {
    label: "Valoare auto vândute (EUR)",
    type: "number",
    prefix: "€",
    value: member.statsSalesValueMonth || 0,
    onChange: v => update('statsSalesValueMonth', +v)
  }), /*#__PURE__*/React.createElement(Field, {
    label: "Comision generat (EUR)",
    type: "number",
    prefix: "€",
    value: member.statsCommissionMonth || 0,
    onChange: v => update('statsCommissionMonth', +v)
  }))), /*#__PURE__*/React.createElement("div", {
    className: "form-field full"
...
function AdminLogin({
  ...
  const submit = e => {
    ...
    setErr('');
    // Autentificare server (stabilește sesiunea PHP pentru API calls)
    fetch('/api/auth.php', {
      method: 'POST',
      credentials: 'include',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ user: u, pass: pass })
    }).catch(() => {});
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "brand-logo brand-logo-dark login-logo",
    src: "https://i.ibb.co/6RckDVsj/logo-transparent-ADN-CARS-fundal-negru.png",
    alt: "ADN Cars"
  }), /*#__PURE__*/React.createElement("img", {
    className: "brand-logo brand-logo-light login-logo",
    src: "https://i.ibb.co/v6P70Gf2/ADN-Cars-logo-transparent-fundal-deschis.png",
    alt: "ADN Cars"
  }), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "lb-h"
  }, "ADN Cars \xB7 Admin"), /*#__PURE__*/React.createElement("div", {
    className: "lb-s"
  }, "Administrare stoc \xB7 Acces agent / administrator"))), /*#__PURE__*/React.createElement("div", {
