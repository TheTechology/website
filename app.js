...
const ACCENT_PALETTES = {
  "#23717a": {
    ink: "#ffffff",
    soft: "rgba(35, 113, 122, 0.14)",
    glow: "rgba(35, 113, 122, 0.32)"
  },
  // Teal
  "#b87333": {
    ink: "#160a02",
...
function App() {
  ...
  uEf(() => {
    ...
    const ac = ACCENT_PALETTES[tweaks.accent] || ACCENT_PALETTES["#23717a"];
  ...
  if (parts.length === 0) page = /*#__PURE__*/React.createElement(HomePage, {
    ...
    showToast: showToast,
    cars: publishedCars
  });else if (parts[0] === 'leasing') page = /*#__PURE__*/React.createElement(LeasingPage, {
    t: t
  });else if (parts[0] === 'cum-functioneaza') page = /*#__PURE__*/React.createElement(CumFunctioneazaPage, {
    t: t
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    t: t
  }), !isAdmin && /*#__PURE__*/React.createElement("a", {
    className: "wa-float",
  ...
  }, /*#__PURE__*/React.createElement(IconWhatsApp, {size: 28})), /*#__PURE__*/React.createElement(Toast, {
    message: toast.msg,
    show: toast.show
    ...
    label: "Accent",
    value: tweaks.accent,
    options: ['#23717a', '#b87333', '#c0c4cc', '#8b2a3a'],
